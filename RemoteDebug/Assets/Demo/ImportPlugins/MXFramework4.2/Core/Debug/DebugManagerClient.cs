...
namespace Mx.Log
{
    ...
    public class DebugManagerClient : MonoSingleton<DebugManagerClient>
    {
        #region 数据声明
        ...
        private void HandleLog(string condition, string stackTrace, LogType type)
        {
            ...
            ExceptionEventArgs debugData = new ExceptionEventArgs(time, type, condition, stackTrace);            
        ...
        {
            iPEndPoint = new IPEndPoint(IPAddress.Parse("172.16.7.128"), DebugDefine.UTP_PORT);
            socket = new Socket(AddressFamily.InterNetwork, SocketType.Dgram, ProtocolType.Udp);
            socket.SetSocketOption(SocketOptionLevel.Socket, SocketOptionName.Broadcast, 1);
        }

        private void SedLogData(ExceptionEventArgs debugData)
        {
